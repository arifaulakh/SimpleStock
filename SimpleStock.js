...
funtion EPS(inputNumber)//This function is responsible for evaluating the inputted earnings per share metric in order to establich whether or not it fits the necessitated criteria
{if (inputNumber >= 10)
...
function divYield(inputNumber)//This function is responsible for 
{if (0 < inputNumber < 5)
